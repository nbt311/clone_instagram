                        ...
                        <div className='flex h-[80vh]'>
                            <div className=' w-[45%] flex flex-col justify-center'>
                                <img className='max-h-full w-full'
                                     src="https://cdn.pixabay.com/photo/2023/11/02/11/32/woman-8360355_640.jpg" alt=""/>
                            </div>
                            <div className='w-[55%] pl-10'>
                                <div className='flex justify-between items-center py-5'>
                                    <div className='flex items-center'>
                                        <div>
                                            <img className='w-9 h-9 rounded-full' src="https://cdn.pixabay.com/photo/2023/11/02/11/32/woman-8360354_640.jpg" alt=""/>
                                        </div>
                                        <div className='ml-2'>
                                            <p>username</p>
                                        </div>
