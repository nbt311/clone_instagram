            ...
            <div className='border rounded-md w-full'>
                <div className='flex justify-between items-center w-full py-4 px-5'>
                    <div className='flex items-center'>
                        <img className='h-12 w-12 rounded-full' src="https://cdn.pixabay.com/photo/2023/11/02/11/32/woman-8360354_640.jpg" alt=""/>
                        <div className='pl-2'>
                            <p className='font-semibold text-sm'>usesrname</p>
                ...
                <div className='w-full'>
                    <img className='w-full' src="https://cdn.pixabay.com/photo/2023/11/02/11/31/woman-8360346_640.jpg" alt=""/>
                </div>
